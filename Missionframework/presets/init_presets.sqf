...
KPLIB_b_squadAssault            = KPLIB_b_squadAssault                   select {[_x] call KPLIB_fnc_checkClass};
...
KPLIB_o_statics_88              = KPLIB_o_statics_88                select {[_x] call KPLIB_fnc_checkClass};
{
...
KPLIB_b_inf_classes append (KPLIB_b_squadLight + KPLIB_b_squadInf + KPLIB_b_squadAT + KPLIB_b_squadAssault + KPLIB_b_squadRecon + KPLIB_b_squadPara);
