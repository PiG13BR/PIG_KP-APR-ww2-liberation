...
diag_log text "";
diag_log text "private _turrets_to_build = [";
diag_log text "    // Move the turrets which should be builded to defend the fob from the above to this array";
diag_log text "];";
...
diag_log text "";
diag_log text "[_objects_to_build, _objectives_to_build, _turrets_to_build, _defenders_to_build, _base_corners]";
