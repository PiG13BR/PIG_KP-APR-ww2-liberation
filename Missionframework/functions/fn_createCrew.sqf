...
if (isNull _vehicle) exitWith {["No vehicle provided"] call BIS_fnc_error; _allCrew};
...
if (_typeCrew isEqualTo "") exitWith {["No class provided"] call BIS_fnc_error; _allCrew};
